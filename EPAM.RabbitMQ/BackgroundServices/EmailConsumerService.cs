...
namespace EPAM.RabbitMQ.BackgroundServices
{
    public class EmailConsumerService : BackgroundService
    {
        ...
        public EmailConsumerService(IRabbitMqClient rabbitMqClient, ILoggerFactory loggerFactory, IServiceProvider services)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            await channel.BasicConsumeAsync(RabbitMqConstants.EmailNotificationQueue, false, consumer, stoppingToken);
